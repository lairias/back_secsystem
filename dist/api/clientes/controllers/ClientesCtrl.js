      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            return _context.abrupt("return", res.json(clientes["0"]));
...
exports.actualizarCliente = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(req, res, next) {
    var errors, _req$body2, nom_empresa, correo_electronico, des_contrato, fec_ini_contrato, fec_fin_contrato, usr_registro, cod, query, result;
    ...
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            _req$body2 = req.body, nom_empresa = _req$body2.nom_empresa, correo_electronico = _req$body2.correo_electronico, des_contrato = _req$body2.des_contrato, fec_ini_contrato = _req$body2.fec_ini_contrato, fec_fin_contrato = _req$body2.fec_fin_contrato, usr_registro = _req$body2.usr_registro;
            cod = req.params.cod;
            query = "CALL UPDATE_CLIENTE(?, ?, ?, ?, ?, ?, ?);";
            _context4.prev = 6;
            _context4.next = 9;
            return mysqlConnection.query(query, [cod, nom_empresa, correo_electronico, des_contrato, fec_ini_contrato, fec_fin_contrato, usr_registro]);
