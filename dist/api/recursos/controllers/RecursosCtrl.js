...
exports.agregarRecurso = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(req, res, next) {
    var errors, _req$body, des_recurso, serie_recurso, almacen, usr_registro, query, result;
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            _req$body = req.body, des_recurso = _req$body.des_recurso, serie_recurso = _req$body.serie_recurso, almacen = _req$body.almacen, usr_registro = _req$body.usr_registro;
            query = "CALL INSERT_RECURSO(?, ?, ?, ?);";
            _context3.prev = 5;
            _context3.next = 8;
            return mysqlConnection.query(query, [des_recurso, serie_recurso, almacen, usr_registro]);
...
exports.actualizarRecurso = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(req, res, next) {
    var errors, _req$body2, des_recurso, serie_recurso, almacen, usr_registro, cod, query, result;
    ...
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            _req$body2 = req.body, des_recurso = _req$body2.des_recurso, serie_recurso = _req$body2.serie_recurso, almacen = _req$body2.almacen, usr_registro = _req$body2.usr_registro;
            cod = req.params.cod;
            query = "CALL UPDATE_RECURSO(?, ?, ?, ?, ?);";
            _context4.prev = 6;
            _context4.next = 9;
            return mysqlConnection.query(query, [cod, des_recurso, serie_recurso, almacen, usr_registro]);
